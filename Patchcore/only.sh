...
python run_patchcore_infer_only.py \
  --model_dir "/home/yamamoao/patchcore_git/patchcore-inspection/results/pose_results/safe_pose_train_24/models/mvtec_safe_pose" \
  --data_path "/home/yamamoao/patchcore_git/datasets/pose_dataset" \
  --subdataset safe_pose \
  --gpu 0 \
  --batch_size 1 \
  --num_workers 4 \
